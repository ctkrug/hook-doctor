...
const CONCRETE_NOUNS = new Set([
  "blood", "rain", "glass", "iron", "stone", "steel", "bone", "ash", "smoke",
  "fire", "ice", "snow", "dust", "mud", "wood", "brick", "knife", "gun",
  "wire", "nail", "salt", "sand", "wave", "thunder", "thorn", "feather",
  "leather", "silk", "copper", "rust", "gravel", "granite", "timber",
  "bark", "root", "branch", "moss", "rope", "chain", "flame", "shadow",
  "shard", "splinter", "gravestone", "candle", "lantern", "boot", "fist",
  "tongue", "skin", "sweat", "tear", "scar",
]);

/** Abstract filler nouns — "the situation", "a feeling" — with no sensory weight. */
const ABSTRACT_NOUNS = new Set([
  "feeling", "truth", "reality", "situation", "idea", "concept", "notion",
  "belief", "justice", "freedom", "fate", "destiny", "meaning", "purpose",
  "existence", "consciousness", "emotion", "thought", "opinion", "value",
  "principle", "theory", "faith", "circumstance", "condition", "essence",
  "possibility", "potential", "experience", "perspective", "awareness",
  "wisdom", "knowledge", "understanding", "nature", "society", "culture",
]);
...
export function imageryDensity(input: string): RuleResult {
  ...
  if (concrete.length > 0) {
    ...
    detail = "No strongly concrete or abstract nouns detected — imagery is neutral.";
  }
